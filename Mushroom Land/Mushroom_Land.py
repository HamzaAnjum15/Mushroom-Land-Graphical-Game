...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self,type):
        ...
        if type == 'fly':
            fly_1=pygame.image.load('flyFly1.png').convert_alpha()
            fly_2=pygame.image.load('flyFly2.png').convert_alpha()
            self.frames=[fly_1,fly_2]
            y_pos=210
        else:
            snail_1=pygame.image.load('snailWalk1.png').convert_alpha()
            snail_2=pygame.image.load('snailWalk2.png').convert_alpha()
...
pygame.display.set_caption('Mushroom Land')
...
game_name=test_font.render('Mushroom Land',False,(111,196,169))
